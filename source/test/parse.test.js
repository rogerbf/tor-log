...
import parse from '../library/parse.js'
...
//   const source = createTestStream(testData.A)
//   const parser = parse()
//
//   const expected = {
//     eventCount: 3,
...
//       {
//         severity: `notice`,
//         raw: `Nov 23 11:27:43.438 [notice] Configuration file "/usr/local/etc/tor/torrc" not present, using reasonable defaults.`
//       },
//       {
//         severity: `warn`,
//         raw: `Nov 23 11:27:43.446 [warn] Warning from libevent: kq_init: detected broken kqueue; not using.: Invalid argument`
//       },
//       {
//         severity: `notice`,
//         raw: `Nov 23 11:27:43.446 [notice] Opening Socks listener on 127.0.0.1:9050`
//       }
//     ]
//   }
//
